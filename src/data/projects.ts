...
export const projects: Project[] = [
  {
    ...
    description:
      "Helping local businesses cut customer response time to near-zero with a multilingual AI agent that replies on WhatsApp, Instagram, Telegram, Viber, and Messenger — in Kurdish, Arabic, and English, 24/7.",
  ...
  },
  {
    ...
    title: "Ashti Library",
    description:
      "Bringing a Kurdish bookstore online for the first time — readers now discover books in their own language, get AI-powered recommendations, and order via WhatsApp instead of in-store-only.",
  ...
  },
  {
    ...
    title: "True Prence",
    description:
      "Eliminating manual attendance and proxy sign-ins for classrooms — students are marked present passively as the camera recognizes up to 20 faces per frame, with full audit reports.",
  ...
  },
  {
    ...
    description:
      "Making sign-language communication accessible to ~250,000 Kurds with hearing and speech difficulties using only a regular laptop camera — no specialized hardware required.",
  ...
  },
  {
    ...
    description: "Moving a Kurdish car dealership off paper and spreadsheets onto a single RTL platform — staff now track inventory, customers, and sales in real time, with role-based access for each team.",
  ...
  },
  {
    ...
    description: "Scaling dealership operations for a larger client — installment payments, granular permissions, and separated operational/archival data so finance, sales, and admins each see only what they need.",
