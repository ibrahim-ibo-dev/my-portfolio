...
export const metadata: Metadata = {
  ...
  keywords: [
    "Ibrahim Hussein",
    "Ibrahim Hussein developer",
    "Ibrahim Hussein portfolio",
    "Ibrahim Hussein Kurdistan",
    "Ibrahim Hussein Erbil",
    "Ibrahim Hussein computer engineer",
    "Ibrahim Hussein AI",
    "Ibrahim developer Iraq",
    "Ibrahim engineer Kurdistan",
    "computer engineer Erbil",
    "AI developer Kurdistan",
    "full-stack developer Kurdistan",
    "Kurdish developer",
    "CSAI",
    "HITEX 2025",
    "Chat Mart",
    "Salahaddin University developer",
    "React developer Kurdistan",
    "Next.js developer Iraq",
    "Python AI developer",
    "machine learning Kurdistan",
    "ibrahim-eng.dev",
  ],
